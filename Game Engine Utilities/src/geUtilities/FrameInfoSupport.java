...
public class FrameInfoSupport implements ActionListener {
	...
	public FrameInfoSupport (String aFrameName, GameEngineManager aGameEngineManager, 
							ArrayList<XMLFrame> aConfigFrames) {
		configFrames = aConfigFrames;
		gameEngineManager = aGameEngineManager;
